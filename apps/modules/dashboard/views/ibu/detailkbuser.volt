       ...
       <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div>
                <ul style="margin-top: 20px;  margin-left: 90px; margin-right: 50%;" class="list-group">
                        <li class="list-group-item list-group-item-primary">Tanggal Datang: {{kb['tanggal_datang']}}</li>
                        <li class="list-group-item list-group-item-primary">Berat Badan: {{kb['berat_badan']}}</li>
                        <li class="list-group-item list-group-item-primary">Tekanan Darah: {{kb['tekanan_darah']}}</li>
                        <li class="list-group-item list-group-item-primary">Tanggal Kembali: {{kb['tanggal_kembali']}}</li>
                </ul>
            </div>

            <a href="{{ url('listuserkb') }}" style="margin-top: 20px; margin-left: 90px;" class="btn btn-danger">Kembali</a>     
