...
<div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul style="margin-left: 10px;" class="list-unstyled">
                ...
                <li>
                    <a href="listuserkb">Keluarga Berencana</a>
                </li>
...
<!--                         <a href="{{ url('logout') }}">
                    ...
                    <h2 style="font-family:'GothamRounded-Medium'; float: right;">Form Tambah Anak {{ session.get('ibu')['username'] }}</h2>
    ...
    <div class="home-content">
        <!-- <label style="margin-left: 90px;">Form Tambah Anak</label> -->
        <form class="data-form" action="http://bidanku.local/storeanak" method="post" style="margin-left: 90px; width: 80%; position: center; font-family:'GothamRounded-Medium';" enctype="multipart/form-data">
