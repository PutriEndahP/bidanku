...
<!--                         <a href="{{ url('logout') }}">
                    ...
                    <h2 style="font-family:'GothamRounded-Medium'; float: right;">Selamat Datang Ibu, {{ session.get('ibu')['username'] }}!</h2>
