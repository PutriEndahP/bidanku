...
<!--                         <a href="{{ url('logout') }}">
                    ...
                    <h2 style="font-family:'GothamRounded-Medium'; float: right;">List Buku KB Ibu, {{ session.get('ibu')['username'] }}!</h2>
