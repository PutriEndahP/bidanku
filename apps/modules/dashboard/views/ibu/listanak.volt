...
<!--                         <a href="{{ url('logout') }}">
                    ...
                    <h2 style="font-family:'GothamRounded-Medium'; float: right;">Daftar Anak, {{ session.get('ibu')['username'] }} </h2>
    ...
    // tabelnya
        var table = new Tabulator("#example-table", {
            ...
            columns: [
                ...
                {title: "Nama Anak", field: "namaAnak", headerFilter:"input"},
                {title: "Tanggal Lahir", field: "tgllahir", headerFilter:"input"},
                {title: "Usia", field: "usia", headerFilter:"input"},
                {title: "Jenis Kelamin", field: "jeniskelamin", headerFilter:"input"},
                ...
                {
                    title: "Hapus Anak", field: "link", formatter: "link", formatterParams: {
                        labelField: "name",
                        label: "Hapus",
                        urlPrefix: "{{ url('hapusanak/') }}",
                        // target: "_blank",
                    }
                },
                // {
        ...
        table.setData("{{ url('lihatanak') }}");
        // table.setData('daftaribu');
    </script>
