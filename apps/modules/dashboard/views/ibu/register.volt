        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="">
                    ...
                    <h2 style="font-family:'GothamRounded-Medium'; float: right;">Daftar sebagai User Ibu</h2>
            ...
            <form action="store-register" method = "post" style="margin-left: 90px; margin-top: 30px; width: 30%; font-family:'GothamRounded-Medium';">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan nama ibu" name="namaIbu" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" placeholder="Masukkan tanggal lahir" name="tgllahir" value="<?php echo date('Y-m-d'); ?>" required>
                </div>

                <div class="form-group">
                    <label>Usia</label>
                    <input type="text" class="form-control" placeholder="Masukkan usia" name="usia">
                </div>
