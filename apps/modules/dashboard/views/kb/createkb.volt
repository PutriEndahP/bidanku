...
<!--                         <a href="{{ url('logout') }}">
                    ...
                    <h2 style="font-family:'GothamRounded-Medium'; float: right;">Form KB Ibu </h2>
    ...
    <form action="http://bidanku.local/storekb" method = "post" style="margin-left: 90px; width: 80%; position: center; font-family:'GothamRounded-Medium';">
 ...
 -->
        ...
        <div class="form-group row">
          <label for="example-date-input" class="col-2 col-form-label">Tanggal Datang</label>
            <div class="col-10">
                <input class="form-control" name="tanggal_datang" type="date" placeholder="Tanggal Datang" id="example-date-input">
            </div>
        </div>
