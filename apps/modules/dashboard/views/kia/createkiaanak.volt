...
<!--                         <a href="{{ url('logout') }}">
                    ...
                    <h2 style="font-family:'GothamRounded-Medium'; float: right;">Form KIA Anak </h2>
    ...
    <form action="http://bidanku.local/storekiaanak" method = "post" style="margin-left: 90px; width: 80%; position: center; font-family:'GothamRounded-Medium';">

    <!-- <form class="data-form" action="storekmsibu" method="post" enctype="multipart/form-data">
 -->
        <input type="hidden" name="idIbu" id="idIbu" value= {{ anak['idIbu'] }}>
        ...
        <div class="form-group row">
          <label for="example-text-input" class="col-2 col-form-label">Tinggi Badan</label>
            <div class="col-10">
                <input class="form-control" name="tinggi_badan" type="text" id="example-text-input">
            </div>
        </div>
        ...
        <div class="form-group row">
          <label for="example-text-input" class="col-2 col-form-label">Lingkar Kepala</label>
            <div class="col-10">
                <input class="form-control" name="lingkar_kepala" type="text" id="example-text-input">
            </div>
        </div>
        ...
        <div class="form-group row">
          <label for="example-text-input" class="col-2 col-form-label">Imunisasi</label>
            <div class="col-10">
                <input class="form-control" name="Imunisasi" type="text" id="example-text-input">
            </div>
        </div>
...
<!-- 
        ...
        <button class="btn btn-primary" type="submit" style="background-color: #c01f28; margin-top: 10px;">Simpan</button>
