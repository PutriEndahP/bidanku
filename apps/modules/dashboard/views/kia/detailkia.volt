       ...
       <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div>
                <ul style="margin-top: 20px;  margin-left: 90px; margin-right: 50%;" class="list-group">
                        ...
                        <li class="list-group-item list-group-item-primary">Usia Kandungan: {{data['usia_kandungan']}}</li>
                        <li class="list-group-item list-group-item-primary">Vitamin: {{data['vitamin']}}</li>
                        <li class="list-group-item list-group-item-primary">Tanggal Kembali: {{data['tanggal_kembali']}}</li>
                        <li class="list-group-item list-group-item-primary">Catatan: {{data['catatan']}}</li>
            </div>
            ...
            <div>
                <ul style="margin-top: 20px;  margin-left: 90px; margin-right: 50%;" class="list-group">
                        <li class="list-group-item list-group-item-primary">Tanggal: {{data['tanggal']}}</li>
                         <li class="list-group-item list-group-item-primary">Tinggi Badan: {{data['tinggi_badan']}}</li>
                        <li class="list-group-item list-group-item-primary">Berat Badan: {{data['berat_badan']}}</li>
                        <li class="list-group-item list-group-item-primary">Lingkar Kepala: {{data['lingkar_kepala']}}</li>
                        <li class="list-group-item list-group-item-primary">Imunisasi: {{data['imunisasi']}}</li>
                        <li class="list-group-item list-group-item-primary">Vitamin: {{data['vitamin']}}</li>
                        <li class="list-group-item list-group-item-primary">Tanggal Kembali: {{data['tanggal_kembali']}}</li>
                        <li class="list-group-item list-group-item-primary">Catatan: {{data['catatan']}}</li>
            </div>
            ...
            <a href="{{ url('daftarkia') }}" style="margin-top: 20px; margin-left: 90px;" class="btn btn-danger">Kembali</a>     
