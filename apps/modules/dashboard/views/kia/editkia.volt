...
<div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul style="margin-left: 10px;" class="list-unstyled">
                ...
                <li>
                    <a href="#">Daftar Kesehatan Ibu Anak</a>
                </li>
               <!--  <li>
...
<!--                         <a href="{{ url('logout') }}">
                    ...
                    <h2 style="font-family:'GothamRounded-Medium'; float: right;">Form Edit KIA </h2>
    ...
    <form action="http://bidanku.local/storeedit" method = "post" style="margin-left: 90px; width: 80%; position: center; font-family:'GothamRounded-Medium';">

    <!-- <form class="data-form" action="storekmsibu" method="post" enctype="multipart/form-data">
 -->
        <input type="hidden" name="idIbu" id="idIbu" value= {{ kia['idIbu'] }}>

         <input type="hidden" name="idAnak" id="idAnak" value= {{ kia['idAnak'] }}>

         <input type="hidden" name="idKia" id="idKia" value= {{ kia['idKia'] }}>

        <div class="form-group row">
          <label for="example-date-input" class="col-2 col-form-label">Tanggal</label>
            <div class="col-10">
                <input class="form-control" name="tanggal" type="date" placeholder="Tanggal Datang" id="example-date-input" value="{{ kia['tanggal'] }}">
            </div>
        </div>
        ...
        <div class="form-group row">
          <label for="example-text-input" class="col-2 col-form-label">Berat Badan</label>
            <div class="col-10">
                <input class="form-control" name="berat_badan" type="text" id="example-text-input" value="{{ kia['berat_badan'] }}">
            </div>
        </div>

        <div class="form-group row">
          <label for="example-text-input" class="col-2 col-form-label">Tinggi Badan</label>
            <div class="col-10">
                <input class="form-control" name="tinggi_badan" type="text" id="example-text-input" value="{{ kia['tinggi_badan'] }}">
            </div>
        </div>

        <div class="form-group row">
          <label for="example-text-input" class="col-2 col-form-label">Lingkar Kepala</label>
            <div class="col-10">
                <input class="form-control" name="lingkar_kepala" type="text" id="example-text-input" value="{{ kia['lingkar_kepala'] }}">
            </div>
        </div>

        <div class="form-group row">
          <label for="example-text-input" class="col-2 col-form-label">Imunisasi</label>
            <div class="col-10">
                <input class="form-control" name="Imunisasi" type="text" id="example-text-input" value="{{ kia['Imunisasi'] }}">
            </div>
        </div>
       ...
       <div class="form-group row">
          <label for="example-text-input" class="col-2 col-form-label">Vitamin</label>
            <div class="col-10">
                <input class="form-control" name="vitamin" type="text" id="example-text-input" value="{{ kia['vitamin'] }}">
            </div>
        </div>
        ...
        <div class="form-group row">
          <label for="example-date-input" class="col-2 col-form-label">Tanggal Kembali</label>
            <div class="col-10">
                <input class="form-control" name="tanggal_kembali" type="date" placeholder="Tanggal Datang" id="example-date-input" value="{{ kia['tanggal_kembali'] }}">
            </div>
        </div>
        ...
        <div class="form-group row">
          <label for="example-text-input" class="col-2 col-form-label">Catatan</label>
            <div class="col-10">
                <input class="form-control" name="catatan" type="text" placeholder="Tulis catatan jika ada" id="example-text-input" value="{{ kia['catatan'] }}">
            </div>
        </div>
<!-- 
 ...
 -->
        ...
        <div class="form-group row">
          <label for="example-text-input" class="col-2 col-form-label">Tekanan Darah</label>
            <div class="col-10">
                <input class="form-control" name="tekanan_darah" type="text" id="example-text-input" value="{{ kia['tekanan_darah'] }}">
            </div>
        </div>
        ...
        <div class="form-group row">
          <label for="example-text-input" class="col-2 col-form-label">Usia Kandungan</label>
            <div class="col-10">
                <input class="form-control" name="usia_kandungan" type="text" id="example-text-input" value="{{ kia['usia_kandungan'] }}">
            </div>
        </div>
