...
<!--                         <a href="{{ url('logout') }}">
                    ...
                    <h2 style="font-family:'GothamRounded-Medium'; float: right;">Selamat Datang Bidan, </h2>
    ...
    // tabelnya
        var table = new Tabulator("#example-table", {
            ...
            columns: [
                ...
                {
                    title: "Tambah KIA Anak", field: "idAnak", formatter: "link", formatterParams: {
                        labelField: "name",
                        label: "Tambah KIA",
                        urlPrefix: "{{ url('createkiaanak/') }}",
                        // target: "_blank",
                    }
                },
                // {
        ...
        table.setData("{{ url('listuseranak') }}");
