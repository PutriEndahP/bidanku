...
<!--                         <a href="{{ url('logout') }}">
                    ...
                    <h2 style="font-family:'GothamRounded-Medium'; float: right;">Selamat Datang Bidan, {{ session.get('bidan')['username'] }}  </h2>
