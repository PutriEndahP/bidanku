 ...
 <div id="content">
       ...
       <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="">
                    ...
                    <h2 style="font-family:'GothamRounded-Medium'; float: right;">Verifikasi Akun User Ibu</h2>
            ...
            <div>
                <ul style="margin-top: 20px;  margin-left: 90px; margin-right: 50%;" class="list-group">
                        ...
                        <li class="list-group-item list-group-item-primary">Nama Ibu: {{data['namaIbu']}}</li>
            </div>

          {% if (data['status'] == 0) %}
            <a href="../verifikasiuser/{{ data['idIbu']}}" style="margin-top: 50px; margin-left: 90px;" class="btn btn-success">Verifikasi</a>
    
            {% else %}
            
            <a href="../daftaribu" style="margin-top: 50px; margin-left: 90px;" class="btn btn-danger">Kembali</a>
            {% endif %}     
