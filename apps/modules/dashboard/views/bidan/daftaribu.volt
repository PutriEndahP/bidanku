...
<!--                         <a href="{{ url('logout') }}">
                    ...
                    <h2 style="font-family:'GothamRounded-Medium'; float: right;">Daftar Pasien & List Verifikasi {{ session.get('bidan')['username'] }}</h2>
    ...
    // tabelnya
        var table = new Tabulator("#example-table", {
            ...
            columns: [
                ...
                {
                    title: "Verifikasi", field: "idIbu", formatter: "link", formatterParams: {
                        labelField: "name",
                        label: "Edit",
                ...
                {
                    title: "Tambah KIA Ibu", field: "idIbu", formatter: "link", formatterParams: {
                        labelField: "name",
                        label: "Tambah KIA",
                        urlPrefix: "{{ url('createkiaibu/') }}",
                        // target: "_blank",
                    }
                },
                {
                    title: "Tambah Buku KB", field: "idIbu", formatter: "link", formatterParams: {
                        labelField: "name",
                        label: "Tambah KB",
                        urlPrefix: "{{ url('createkb/') }}",
                        // target: "_blank",
                    }
                },
