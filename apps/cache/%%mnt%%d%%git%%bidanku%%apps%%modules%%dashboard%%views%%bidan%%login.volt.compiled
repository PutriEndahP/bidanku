        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="">
                    ...
                    <h2 style="font-family:'GothamRounded-Medium'; float: right;">Masuk Sebagai Bidan</h2>
        ...
        <div>
            <form action=" " method = "post" style="margin-left: 90px; margin-top: 50px; width: 30%; font-family:'GothamRounded-Medium';">
                ...
                <div class="custom-control custom-radio">
                  ...
                  <label class="custom-control-label" for="defaultChecked">Ibu</label>
                </div>

                <div class="custom-control custom-radio" >
                  <input value="admin" type="radio" class="custom-control-input" id="defaultUnchecked" name="tipe">
                  <label class="custom-control-label" for="defaultUnchecked">Bidan</label>
                </div> -->
